    ...
    <div className='main'>
      <div className="mainDiv">
        ...
        <ul>
          ...
          <li>Refactor the text on this pat and make this your own portfolio project.</li>
          ...
          <li>This set up for this app might be the mose confusing part. Hang in there..</li>
          <li>
